...
char column_name_in_sheets[ ][5] = {"moisture","temp","air_quality"};                        /*1. The Total no of column depends on how many value you have created in Script of Sheets;2. It has to be in order as per the rows decided in google sheets*/
String Sheets_GAS_ID = "AKfycbyd8K-yr50D5TtLbTTurGbsstREcObHoSxDAg0sqVDvpeLQosIxQ7vDd09HYBZmpdJr";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() 
{
  ...
  WIFI_Connect("Redmi Note 9","987654321");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
